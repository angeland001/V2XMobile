// app/src/features/UI/components/icons/PedestrianIcon.tsx
...
// Phosphor Icons "PersonSimpleWalk" (regular weight)
export const PedestrianIcon: React.FC<PedestrianIconProps> = ({ size = 16, color = '#0082BF' }) => (
